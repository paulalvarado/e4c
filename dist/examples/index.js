    ...
    var dataSource = new DevExpress.data.DataSource({
        load: function(loadOptions) {
            ...
            $.ajax({
                ...
                method: "GET",
                data: { limit: loadOptions.take, offset: loadOptions.skip },
                dataType: "json",
                success: function(response) {
                    deferred.resolve(response.usuarios, { totalCount: response.total });
                },
    ...
    var dataGrid = $("#gridContainer").dxDataGrid({
        ...
        masterDetail: {
            ...
            template: function(container, options) {
                ...
                var userId = options.data.id_usuario;

                // Realizar la consulta AJAX para obtener los detalles del usuario
                $.ajax({
